...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light flex-column" >
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto flex-wrap">
                ...
                <li class="nav-item">
                    <!-- Bouton pour se déconnecter ou accéder à l'inscription/connexion -->
     ...
     <div class="container">
        ...
        <!-- Formulaire pour sélectionner des utilisateurs -->
        <form id="selectionForm" action="selectionner_utilisateurs.php" method="POST">
            ...
            <?php foreach ($auteurs as $auteur): ?>
                <li>
                    <!-- Case à cocher pour sélectionner l'utilisateur -->
    ...
    <!-- Script JavaScript -->
    <script>
        // Gestion des cases à cocher et du bouton de validation
